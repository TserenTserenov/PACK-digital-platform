...
**DayPlan** — ежедневный план работы, генерируемый Стратегом (R1) на основе WeekPlan, inbox-triage и итогов предыдущего дня. Определяет приоритеты, бюджеты времени и carry-over.
