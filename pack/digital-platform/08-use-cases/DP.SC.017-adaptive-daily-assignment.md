...
**Критерий приёмки:** Участник получает задание утром (бот / визуальный фронтенд). Задание учитывает вчерашний прогресс. Выполнение трекается. Наставник видит сводку по группе.
