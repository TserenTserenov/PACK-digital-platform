...
3. **Бюджет двойной на всех масштабах:** физические часы (WakaTime) и часы РП (с мультипликатором). Формат: `Xh РП на результаты / ~Yh физ / ~Zh РП всего (мультипликатор ~N.Nx)`. Показывается в Strategy.md (месяц), WeekPlan (неделя), DayPlan (день).
