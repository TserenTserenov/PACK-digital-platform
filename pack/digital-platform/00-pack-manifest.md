...
| DP.ARCH.004 | Архитектура данных Neon (Database-per-Service) | ARCH | 9 баз данных в Neon по принципу database-per-service. ERD, диаграммы связей, справочник таблиц, принятые архитектурные решения. Принята на встрече ИТ 14 апр 2026, расширена 19 апр 2026 (content-pipeline). | active |
...
| DP.SC.104 | Адаптивная персонализация через цифровой двойник | SC | ЦД обеспечивает адаптивную персонализацию платформы — три механизма: персонализация (платформа), индивидуализация (пользователь), адаптивность (система) | draft |
...
> *Auto-generated by `generate-map.py` on 2026-04-19*
