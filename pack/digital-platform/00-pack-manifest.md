...
| DP.ROLE.100 | Публикатор материалов практикума (Practicum Materials Publisher) | ROLE | Отслеживает папку на Маке наставника и согласованный Телеграм-чат, определяет поток/встречу нового материала и публикует его в каталоге хранилища (Google Диск) с устойчивой ссылкой. При неоднозначности не публикует наугад — передаёт решение агенту или пилоту. | draft |
...
> *Auto-generated by `generate-map.py` on 2026-09-13*
