...
| DP.ARCH.002 | Тиры обслуживания платформы | ARCH | 4-тирная модель обслуживания: T1 Эксперт → T2 Наставник → T3 Со-мыслитель (IWE) → T4 Архитектор. Каждый тир определяет знания, персональные данные, роль ИИ и доступные действия | draft |
...
> *Auto-generated by `generate-map.py` on 2026-02-16*
