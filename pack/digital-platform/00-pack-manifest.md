...
**Описание**: Предметная область ИТ-платформы экосистемы развития интеллекта: архитектура платформы (3 слоя, 5 характеристик), ИИ-системы (агенты + ассистенты), цифровой двойник созидателя, навигация знаний между репозиториями, модульный экзокортекс пользователя, метод экстракции знаний, IPO-паттерн компонентов, отчуждаемость (platform-space vs user-space), генеративность (общее знание → шаблон → fork).
...
| DP.ARCH.001 | Архитектура платформы | ARCH | 3-слойная архитектура ИТ-платформы с 5 характеристиками: эволюционируемость, масштабируемость, обучаемость, генеративность, скорость | active |
...
| DP.M.005 | АрхГейт (ArchGate) | M | Блокирующая оценка архитектурного решения: 5 характеристик (ЭМОГС) + SOTA-сверка. Без прохождения — решение не принимается | active |
...
> *Auto-generated by `generate-map.py` on 2026-02-14*
