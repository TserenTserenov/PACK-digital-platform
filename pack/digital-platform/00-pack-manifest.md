...
| DP.ARCH.004 | Архитектура данных Neon (Database-per-Service) | ARCH | 7 баз данных в Neon по принципу database-per-service. ERD, диаграммы связей, справочник таблиц, принятые архитектурные решения. Принята на встрече ИТ 14 апр 2026. | active |
