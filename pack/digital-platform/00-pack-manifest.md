...
| DP.ROLE.060 | Презентатор | ROLE | Роль, готовящая и проводящая публичные выступления (доклады, презентации) от имени IWE/MIM. Обеспечивает единый стиль и структурный каркас слайдов. | draft |
...
| DP.SC.047 | Презентация к публичному событию | SC | Подготовка и проведение публичного выступления (доклада, презентации) с единым стилем IWE/MIP. Вход — тема и событие, выход — Marp-слайды + PDF + отчёт. | draft |
