...
| DP.SC.119 | Рабочее пространство из браузера | SC | Пользователь получает работающее IWE-пространство из браузера — без git, без терминала, без VS Code | draft |
...
> *Auto-generated by `generate-map.py` on 2026-04-08*
