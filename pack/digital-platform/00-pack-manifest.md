...
| DP.ROLE.046 | IWE Stage Controller | ROLE | Ежедневный фоновый контролёр-диспетчер двумерной стадии мастерства IWE (cp.iwe × cp.cre): обходит опт-инов, сравнивает фактический профиль с маркером связи со ступенью Ученика (FORM.089 §6.3), отправляет TG-нудж для простых шагов или enqueue render для сложного материала. | draft |
