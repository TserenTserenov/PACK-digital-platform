...
| DP.ARCH.002 | Тиры обслуживания платформы | ARCH | 5-тирная модель обслуживания: T0 Старт → T1 Изучение → T2 Персонализация → T3 Созидание (IWE) → T4 Администрирование. Название тира = действие пользователя. Каждый тир определяет знания, персональные данные, роль ИИ и доступные действия | draft |
...
> *Auto-generated by `generate-map.py` on 2026-02-17*
