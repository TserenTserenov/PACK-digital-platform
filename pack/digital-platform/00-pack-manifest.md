...
| DP.KR.030 | Принцип триады учёт-доступ-аудит | KR | Три функции институционального контроля — Учёт, Доступ, Аудит — должны быть структурно разделены. Совмещение любых двух из трёх в одной роли нарушает принцип независимости контроля. Серия KR.030–039 зарезервирована под принципы этой триады. | draft |
