...
| DP.ARCH.004 | Архитектура данных Neon (Database-per-Service) | ARCH | 7 баз данных в Neon по принципу database-per-service. ERD предметной области по базам. Принята на встрече ИТ 14 апр 2026. | active |
