...
## 11. Уровни системы (Platform Levels)

> Экзокортекс существует в контексте 4-уровневой модели. Платформа (L2) раздаёт шаблон (L3), пользователь инстанцирует его в личный IWE (L4).

| Уровень | Что | Роль экзокортекса на этом уровне |
|---------|-----|----------------------------------|
...
Перед интеграцией нового инструмента/агента в ЛЮБОЙ уровень — определить:

1. Тип (инструмент / агент)
2. Уровень (L2 Platform / L3 Template / L4 Personal)
...
| Уровень | Где описывать интеграцию |
|---------|--------------------------|
...
> Полная модель уровней: [DS-ecosystem-development/0.OPS/0.1.Knowledge-Logic/11-platform-levels.md](https://github.com/TserenTserenov/DS-ecosystem-development)
