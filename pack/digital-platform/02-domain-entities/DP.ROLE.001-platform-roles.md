...
| **SOP роли** (описание метода) | Алгоритм выполнения: Вход → Действие → Выход (ВДВ) | Pack, чей метод применяется | PACK-education/03-methods/ (образовательный метод) |
...
- Один SOP может использоваться несколькими ролями (EDU.M.001 Scaffolding → EDU.R.003 Navigator, R27 Tailor)
