...
> **Независимость R24:** Owner Role R24 ≠ Платформа (организационная независимость). R23/R25/R26 — Owner = Платформа, методологическая независимость. Подробно: [DP.ROLE.024](DP.ROLE.024-auditor.md) §1.
