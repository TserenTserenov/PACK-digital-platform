...
### 5.1 Семь типов nudge-сообщений

Каждый тип отвечает на свой вопрос и работает на определённом этапе жизненного цикла пользователя. Типы 1-5 покрывают T0-T3 (потребление), тип 6 — траекторию внутри T1-T3, тип 7 — T4 (созидание).
