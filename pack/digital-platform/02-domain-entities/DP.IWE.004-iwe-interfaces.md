...
## 8. REINDEX-TEST-MARKER-20260408

Этот маркер добавлен для E2E теста webhook-driven reindex pipeline. Если вы видите этот текст через knowledge_search — pipeline работает. Удалить после верификации.