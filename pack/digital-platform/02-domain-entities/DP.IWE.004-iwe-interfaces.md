...
| **Чтение личных знаний (L4)** | да | да | да | да | да | ⚠️ |
...
## 8. Автоматическая переиндексация (E2E VERIFIED 2026-04-08)

Документ автоматически переиндексируется при push через webhook pipeline: GitHub push → Gateway webhook → knowledge-mcp /reindex. Задержка: менее 60 секунд.