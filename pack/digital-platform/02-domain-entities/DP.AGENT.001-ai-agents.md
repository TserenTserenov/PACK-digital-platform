...
| I2 | Синхронизатор (bash) | Инструмент | 1 | DS-synchronizer |
| I3 | Шаблонизатор (bash) | Инструмент | 0 | DS-exocortex-setup-agent |
| I4 | MCP-серверы | Инструмент | 0 | DS-MCP |
| I5 | launchd | Инструмент | 0 | — (macOS) |
| I6 | Статистик | Инструмент | 1 | DS-pulse-agent |
| I7 | Наладчик | Инструмент | 1 | DS-fixer-agent |
| I8 | Оценщик | Инструмент | 1 | DS-evaluator-agent |
...
**Статистика:** 2 агента (Claude + Пользователь), 8 инструментов, 21 роль (14 + 7), 16 автоматизированных процессов.
