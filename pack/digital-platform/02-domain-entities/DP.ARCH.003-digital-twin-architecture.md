...
> **ЦД как инфраструктура адаптивной персонализации:** ЦД — основа механизма Персонализации (механизм 1 из 3 в [DP.CONCEPT.003](DP.CONCEPT.003-adaptive-personalization.md)). Данные ЦД → Портной → персонализированный контент. Механизм Адаптивности (BKT/HLR) обновляет ЦД по обратной связи.
