...
| MC (machine) | Данные агент-для-агента (диалоги, служебные логи, журналы входов — сырой ввод пользователя со следом маршрута), человек не читает day-to-day | Доменное знание; решения/планы; дом фактов о пользователе (тип 2.1) | `MC-{slug}` (напр. `MC-sessions`, `MC-data`) |
