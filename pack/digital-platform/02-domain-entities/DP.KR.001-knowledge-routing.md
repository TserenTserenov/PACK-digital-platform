...
1. **Нет формального триггера ревизии memory/.** MEMORY.md говорит «≤11 файлов, ≤100 строк», но триггер ревизии не формализован (только при Week Close неявно). **В работе (WP-477 Ф2, открыт 10.07.2026):** содержимое карты сверено с практикой за 2 месяца (Ф1, добавлены 3 строки — bug-отчёт, extraction-report, сессионный отчёт), встраивание конкретного шага ревизии в Week/Month Close — следующая фаза.
