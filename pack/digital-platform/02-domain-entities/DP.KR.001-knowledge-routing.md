...
| MC (machine) | Данные агент-для-агента (диалоги, служебные логи), человек не читает day-to-day | Доменное знание; решения/планы; личные данные пользователя | `MC-{slug}` (напр. `MC-sessions`) |
