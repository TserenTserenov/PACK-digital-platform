...
**Инвариант runtime-цикла:** Любая работа в IWE проходит через цикл **open → work → close** (ОРЗ-фрактал). Этот контракт не зависит от хоста. WP-348 специфицирует open/work/close как хост-агностичный интерфейс для Hermes runtime. → DP.SC.046
