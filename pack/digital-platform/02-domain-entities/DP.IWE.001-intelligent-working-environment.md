...
type: domain-entity
status: draft
summary: "IWE — персональная интегрированная среда для интеллектуальной работы: экзокортекс + ИИ-агенты + инструменты + рабочее пространство + методология. Позиционирование: почему именно IWE, а не агенты/экзокортекс/FPF по отдельности."
created: 2026-02-23
trust:
  F: 3
  G: domain
...
| Экзокортекс | IWE |
|-------------|-----|
| Память и инструкции (CLAUDE.md + memory/) | Память + агенты + инструменты + методология + рабочее пространство |
| Хранит знания | Применяет знания в работе |
| Усиливает память | Усиливает мышление, планирование, создание |
| Компонент IWE | Целое |

**Экзокортекс** — подсистема памяти и инструкций внутри IWE (DP.EXOCORTEX.001). Он отвечает за то, ЧТО ИИ знает и КАК себя ведёт. Но экзокортекс не включает:

- **Агентов**, которые действуют автономно (Стратег, Экстрактор)
- **Инструменты**, через которые человек работает (бот, CLI, MCP)
- **Рабочее пространство**, где хранятся артефакты (git-репо, стратегия, Pack)
- **Цифровой двойник**, который отражает развитие человека
...
│                                                      │
│  ┌─────────────┐  ┌──────────────┐  ┌────────────┐ │
│  │ Экзокортекс │  │  ИИ-агенты   │  │ Инструменты│ │
│  │             │  │              │  │            │ │
│  │ CLAUDE.md   │  │ Claude Code  │  │ Git        │ │
│  │ MEMORY.md   │  │ Стратег      │  │ MCP        │ │
│  │ memory/*.md │  │ Экстрактор   │  │ WakaTime   │ │
│  │ протоколы   │  │ Синхронизатор│  │ Бот        │ │
│  └─────────────┘  └──────────────┘  └────────────┘ │
│                                                      │
│  ┌──────────────┐  ┌──────────────┐  ┌────────────┐ │
│  │ Методология  │  │  Рабочее     │  │ Цифровой   │ │
│  │              │  │ пространство │  │ двойник    │ │
│  │ FPF (мышл.)  │  │              │  │            │ │
│  │ SPF (знания) │  │ DS-strategy/ │  │ Профиль    │ │
│  │ Протоколы    │  │ Pack (свои)  │  │ Прогресс   │ │
│  │ Различения   │  │ Репозитории  │  │ Рефлексия  │ │
│  └──────────────┘  └──────────────┘  └────────────┘ │
│                                                      │
└─────────────────────────────────────────────────────┘
```

| Компонент | Что | Зачем | Без него |
|-----------|-----|-------|----------|
| **Экзокортекс** | Память и инструкции ИИ | ИИ знает контекст, правила, историю | ИИ = stateless ассистент |
| **ИИ-агенты** | Исполнители с автономностью | Автоматизация: планирование, извлечение, синхронизация | Всё вручную |
| **Инструменты** | Детерминированные системы | Код, хранение, трекинг, интерфейс | Нет рабочей инфраструктуры |
| **Методология** | FPF + SPF + протоколы | Корректность мышления и работы | Вайб-работа (DP.D.021) |
| **Рабочее пространство** | Репозитории, стратегия | Хранение артефактов, версионирование | Нет персистентности |
| **Цифровой двойник** | Модель пользователя | Персонализация, рефлексия, трекинг развития | ИИ не знает пользователя |

**Принцип целостности:** Убрать любой компонент — и IWE деградирует до одного из альтернатив (§ 2.1–2.5). Ценность именно в интеграции.
...
- IWE: полная среда с 6 компонентами (§ 3), методологией, агентами и эволюцией.
...
- [DP.EXOCORTEX.001](DP.EXOCORTEX.001-modular-exocortex.md) — подсистема памяти и инструкций (компонент IWE)
