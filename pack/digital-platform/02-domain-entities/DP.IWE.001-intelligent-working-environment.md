...
> **Архитектурная позиция (21 мая 2026):** IWE = **дистрибутив** (слой 4) на основе агентного runtime (слой 1). Аналогия: Ubuntu на ядре Linux. Ядро (Hermes runtime, слой 1) исполняет агентные задачи; дистрибутив (IWE, слой 4) добавляет методологию, Pack-знания, протоколы ОРЗ и персональную конфигурацию. При смене runtime-хоста дистрибутив переезжает без изменения методологии. Подробнее: § 5.2.
...
| 1 | Hermes runtime | Команда Андрея | Агентный runtime (исполнение задач, очереди) |
