...
| **Тир (T0–T4)** | Какие данные платформы доступны | Прогрессия пользователя (триггеры событий) | `USER_STATE.tier` в aist-bot |
...
- Фиксируется: дата, основание, кто присвоил
...
**Тир** — `aist-bot #6`, `USER_STATE.tier` (текущий) + `TIER_EVENTS` (история).
