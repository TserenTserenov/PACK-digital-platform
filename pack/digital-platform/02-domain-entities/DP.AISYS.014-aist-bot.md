...
> Тиры обслуживания (T1-T4) определяют, что Claude знает и умеет при консультации. Подробнее: [DP.ARCH.002 Тиры обслуживания](DP.ARCH.002-service-tiers.md).
> Бот реализует T1 (Эксперт) и T2 (Наставник). T3-T4 работают через Claude Code.
