...
3. Распределить бюджет времени
4. **ТОС-недели:** определить узкое горлышко на эту неделю
5. Сформировать WeekPlan W{N} по шаблону (protocol-open.md § Шаблон WeekPlan)
