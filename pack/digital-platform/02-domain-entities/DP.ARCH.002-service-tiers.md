...
type: domain-entity
status: draft
summary: "5-тирная модель обслуживания: T1 Старт → T2 Изучение → T3 Персонализация → T4 Созидание (IWE) → T5 Администрирование. Название тира = действие пользователя. Каждый тир определяет знания, персональные данные, роль ИИ и доступные действия"
created: 2026-02-16
updated: 2026-02-17
trust:
  F: 4
...
| 3 | Нет пути апгрейда — непонятно, зачем заполнять ЦД или ставить экзокортекс | Каждый тир даёт конкретное улучшение роли ИИ: ассистент → эксперт → наставник → со-мыслитель |
