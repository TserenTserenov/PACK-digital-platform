...
related:
  ...
  downstream_consumers:
    ...
    - DP.ROLE.053 Артефактор (R29)     — Аналитик идентифицирует ограничение, Артефактор декомпозирует на стадии с физическими артефактами
created: 2026-05-20
updated: 2026-05-20
wp: WP-313
---
...
| **DP.ROLE.053 Артефактор (R29)** | Sibling-роль: Аналитик идентифицирует ограничение и этапы плана; Артефактор декомпозирует этапы на физические артефакты с чеклистами приёмки |
...
**Различие с Артефактором:** Аналитик отвечает на **«куда смотреть»** (какое ограничение, какие этапы, какие зависимости). Артефактор отвечает на **«как сделать»** (каждый этап на физические артефакты с приёмкой). Sequencing: Аналитик → Артефактор.
...
5. **Связь с Артефактором.** Если bottleneck требует open-loop работы ≥3h — auto-call Артефактора для декомпозиции этапов на физические артефакты? Сейчас manual.
...
**Финальное имя:** «Аналитик ограничений» / Constraint Analyst — общее, операционное, не привязано к конкретной школе TOC, удобно ложится в русский ряд других ролей (Стратег, Диагност, Аттестатор, Артефактор).
