...
| 8 | **Персональные данные изолированы** | Доступ к user-space только по делегации | Масштабируемость, Безопасность |
| 9 | **Общее знание → шаблон → fork** | Платформенное знание структурировано для наследования пользователями | Генеративность |
| 10 | **Секреты вне git** | Токены, API-ключи — в локальных конфигах, не в репозиториях | Безопасность |
| 11 | **Per-user blast radius** | Компрометация одного пользователя не затрагивает других | Безопасность, Масштабируемость |
