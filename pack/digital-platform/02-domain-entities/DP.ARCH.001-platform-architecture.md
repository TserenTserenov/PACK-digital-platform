...
| 25 | **AI-first, Human-escalation** | ИИ-персонализация покрывает 80% функций наставника для T1-T2. Наставник подключается по эскалации, не по умолчанию. Масштабирование без линейного роста наставников | М, О |
