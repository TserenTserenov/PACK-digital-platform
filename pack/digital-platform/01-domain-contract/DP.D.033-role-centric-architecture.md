...
## 8. Модульность ролей как следствие
...
### 8.1. Почему модульность ролей важна
...
### 8.2. Реализация в шаблоне (FMT-exocortex-template)
...
| Source-of-truth | Pack = первоисточник для доменного знания | DP.AGENT.001 §3.2 = первоисточник для определения ролей |
