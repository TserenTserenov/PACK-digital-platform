...
**Тест**: «Человек должен понимать этот материал, чтобы принимать решения на его основе?» Да → экзоскелет. Нет (материал промежуточный, для ориентировки) → автопилот.
...
> Источник: анализ подхода Karpathy (LLM Knowledge Base, апрель 2026) vs IWE-архитектура.
