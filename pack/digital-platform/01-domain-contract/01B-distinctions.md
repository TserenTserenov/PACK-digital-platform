...
### D.DTP.015: ИИ-система ≠ ИТ-система
...
### D.DTP.016: Capture-to-Pack ≠ Knowledge Extraction
...
- [ ] Не смешиваете ли ИИ-систему и ИТ-систему в одном компоненте? (D.DTP.015)
...
- [ ] Не путаете ли capture (обнаружение) с extraction (формализация)? (D.DTP.016)
