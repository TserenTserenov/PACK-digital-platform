...
**Соответствие первоисточнику (Левенчук, 28.06.2026):** IWE-«SPF» (Second Principles Framework) = Левенчук-«DPF» (Domain Principles Framework) — один и тот же слой, «вторые принципы» = «доменные принципы». Левенчук переименовал Second→Domain ради ясности для новичков, не из-за неверности «второго». IWE-«Pack» = «конкретный DPF» (наполненный учебник одной области). Вывод: имя «вторые принципы» корректно; нужно соответствие SPF↔DPF, а не отказ от термина. Во внешней коммуникации с сообществом — «DPF», внутри — «SPF».
