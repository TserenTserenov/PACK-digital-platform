...
| **Система платформы** | Любой компонент платформы, выполняющий функции. Делится на ИИ-системы (LLM-зависимые, Слой 3) и ИТ-системы (детерминированные, Слой 2) — D.DTP.015 |
