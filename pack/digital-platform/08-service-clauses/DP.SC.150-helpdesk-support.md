...
3. **Параллельная активность.** Тикет #142 открыт, пилот пишет `/lesson` → бот: «У вас #142. (1) Приостановить (2) Закрыть сначала (3) Отмена». После урока сообщения тикета продолжают приходить с 🛟.
