...
name_ru: "Триаж и техдолг"
name_en: "Triage and technical debt"
type: sc
status: draft
layer: L2-Platform
...
Перед закрытием, откладыванием или изменением приоритета старого замечания сессия повторно проверяет его по текущему состоянию системы. Прежний ярлык и возраст замечания недостаточны для решения: в результате указываются актуальные свидетельства и их связь с выбранным действием. Недостаток свидетельств сохраняется как явная неопределённость.

Проверка критерия: два замечания с одинаковым старым ярлыком, но разными подтверждёнными текущими состояниями — устранённая причина и воспроизводимый сбой действующего сценария — получают различающиеся обоснованные решения.
...
| 5 | Проверка актуальности накопленных замечаний по текущим свидетельствам и приоритизация | Разработчик | S30 Triage Session |
...
DS-my-strategy/inbox/extraction-reports/2026-09-11-inbox-check-3.md, кандидат #4; решение пилота 12.09.2026, peer-сессия 2026-09-12-25-session. Уточнение контракта не является подтверждением его внедрения в сервисе.
