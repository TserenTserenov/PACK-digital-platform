...
- **Без активной подписки БР Gateway возвращает 403.** Триал (T2) в Telegram-боте не даёт доступ к Gateway — это обещание действует только при `subscription_status == "active"` в Ory Kratos. Граница триал↔БР описана в [DP.SC.112 § Техническая граница](DP.SC.112-subscription-billing.md)
