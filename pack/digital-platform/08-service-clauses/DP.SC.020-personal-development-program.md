...
*Создан: 2026-03-22. Обновлён: 2026-03-23 (добавлена архитектура канала «Экзокортекс»). Обновлён: 2026-05-06 (WP-222 Ф5: добавлен раздел «Канал персонального руководства» — актуальная реализация тёплого канала через `personal-guide` репо; различение MVP vs целевое видение).*
