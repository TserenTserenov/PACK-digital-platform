...
**Зачем:** в модели Персона/Память/Контекст (DP.D.052) Память.Derived содержит чувствительные индикаторы (baseline/potential/RCS, engagement, coding_time, IWE-активность). GDPR Art.15 требует прозрачности: субъект может запросить, кто, когда и зачем читал его данные. Без централизованного audit trail:
