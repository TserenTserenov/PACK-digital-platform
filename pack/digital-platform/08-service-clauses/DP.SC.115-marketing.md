...
**Контент-бриф (WP-480):** при написании текста для конкретного сегмента — тон и адресат берутся из карты целевых аудиторий экосистемы (`DS-ecosystem-development/A.Systems-Builder/A1.Teams-and-Communities/A1.1.Meaning/1.1.2. Marketing/audiences/`); отстройка формулируется через продуктивный мем (посадить в whitelist-язык) и разбор непродуктивного (что закрывает blacklist), см. каталог `PACK-systems-art/pack/systems-art/02-domain-entities/catalogs/SA.CAT.001-memes-catalog.md`.
