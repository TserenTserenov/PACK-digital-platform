---
id: DP.SC.011
name: Стратегирование и Планирование
type: sc
status: draft
layer: L4-Personal
summary: "Зонтичное обещание сквозного цикла: неудовлетворённости → приоритеты (стратегирование) → утверждённый план недели (планирование). Реализуется двумя ролями (Стратег + Плановик) через DP.SC.030 + DP.SC.051."
consumer: R17 Стратег-интерактив (пилот-участник), R14 Заказчик (L4 Personal)
created: 2026-03-17
updated: 2026-06-05
related:
  realizes: [S02, S03, S05, S06, S07, S08, S41]
  uses: [DP.M.003, DP.M.008, DP.WP.004, DP.WP.005]
  decomposes_into: [DP.SC.030, DP.SC.051]   # зонтик: discovery (Стратег R1) + планирование (Плановик DP.ROLE.066)
---

# [DP.SC.011] Стратегирование и Планирование

> **Зонтичное обещание (распаковка R1, РП378, 2026-06-05).** Сквозной цикл
> «неудовлетворённости → приоритеты → утверждённый WeekPlan» для пилота (R17 как
> участник сессии, R14 как потребитель плана). После распаковки R1 реализуется **двумя
> ролями через две половины**:
> - **DP.SC.030** (разговор-распаковка, Стратег R1) — половина WHAT/WHY: НЭП → состояние → приоритеты месяца.
> - **DP.SC.051** (совместный недельный ритуал, Плановик DP.ROLE.066) — половина HOW MUCH/WHEN: упаковка приоритетов в неделю с бюджетами.
>
> Это обещание остаётся как **зонтик сквозной ценности для пилота** (он хочет
> «от неудовлетворённостей до плана» как целое); две половины — внутренняя реализация
> распаковки. Провайдеры: R1 Стратег (discovery + стратегическая корректировка) + Плановик
> (упаковка недели/дня). R17 ≠ конкурирующий агент — это роль пилота-участника, провайдер = R1+Плановик.
...
- **Декомпозируется на две половины (распаковка R1):**
  - **DP.SC.030** Разговор-распаковка неудовлетворённостей (Стратег R1, WHAT/WHY).
  - **DP.SC.051** Совместный недельный ритуал Стратега и Плановика (Плановик ведущий, HOW MUCH/WHEN).
