...
**Критерий приёмки:** Новый пользователь от /start до первого DayPlan < 1 день. Знает минимум 3 сценария (планирование, развитие, заметки). Может задать вопрос боту и получить ответ.
