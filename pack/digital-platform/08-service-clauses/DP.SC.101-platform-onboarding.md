...
> **Уточнение (инверсия модели, WP-415, 2026-06-14).** Платформа обслуживает любого совместимого клиента-помощника. IWE — один из поддерживаемых клиентов; Web App, Telegram-бот, Claude Code — примеры каналов входа, не владельцы онбординга.
