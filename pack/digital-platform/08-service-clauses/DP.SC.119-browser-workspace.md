...
- **Доступ без активной подписки БР.** Gateway требует `subscription_status == "active"` в Ory Kratos. Триал (T2) Telegram-бота не даёт права на browser-workspace — граница триал↔БР описана в [DP.SC.112 § Техническая граница](DP.SC.112-subscription-billing.md)
