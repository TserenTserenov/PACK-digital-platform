...
> **Примечание (WP-478, 11.07.2026):** имя «Обучение и развитие» оставлено как домен-термин (архитектурный идентификатор Service Clause), не user-facing текст. Переформулировка пользовательских сообщений (WP-478) его не переименовывает — переименование самого SC было бы отдельным архитектурным решением с широким blast radius по кросс-ссылкам Pack.
