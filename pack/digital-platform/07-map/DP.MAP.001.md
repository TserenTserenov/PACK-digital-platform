...
> Auto-generated from frontmatter on 2026-02-18. Do not edit manually.
...
| DP.D.028 | User Data Tiers — тирование данных пользователя | Объём и тип данных пользователя растёт с каждым тиром: T1 базовый профиль → T2 полный профиль + история → T3 цифровой двойник → T4 личная база знаний | active |
...
| DP.ARCH.002 | Тиры обслуживания платформы | 5-тирная модель обслуживания: T1 Старт → T2 Изучение → T3 Персонализация → T4 Созидание (IWE) → T5 Администрирование. Название тира = действие пользователя. Каждый тир определяет знания, персональные данные, роль ИИ и доступные действия | draft |
...
*Generated by `scripts/generate-map.py` on 2026-02-18*