...
| DP.ARCH.003 | Архитектура цифрового двойника (3-слойная) | 3-слойная архитектура ЦД: Events → State → Views. Event Sourcing + CQRS. 5 schemas Neon (public, development, finance, connections, operations). Безопасность: RLS + 5 ролей PostgreSQL. Эволюция: 5 начальных проекций → CHR-Space (30+ измерений) | approved |
...
| DP.ROLE.012.SC.01 | 01 Strategy Session | Еженедельная сессия стратегирования (пн 7:00): анализ прошлой недели, сдвиг месячного окна и формирование плана на неделю | draft |
