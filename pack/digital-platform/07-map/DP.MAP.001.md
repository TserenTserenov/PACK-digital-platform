...
| DP.ROADMAP.001-A | Neon MVP-greenfield (infra-first, старт 24 апр) | Параллельный к основному Roadmap план: MVP-greenfield с 9 БД активных из 12 целевых (согласно DP.ARCH.004 §1 v2.3), infra-first. Core-team и волонтёры подключаются по факту готовности инфры, не по календарю. | in_progress |
