...
> Auto-generated from frontmatter on 2026-02-14. Do not edit manually.
...
| DP.M.005 | АрхГейт (ArchGate) | Блокирующая оценка архитектурного решения: 5 характеристик (ЭМОГС) + SOTA-сверка. Без прохождения — решение не принимается | active |
...
| ID | Name | Summary | Status |
|----|------|---------|--------|
| DP.ARCH.001 | Архитектура платформы | 3-слойная архитектура ИТ-платформы с 5 характеристиками: эволюционируемость, масштабируемость, обучаемость, генеративность, скорость | active |
...
*Generated by `scripts/generate-map.py` on 2026-02-14*