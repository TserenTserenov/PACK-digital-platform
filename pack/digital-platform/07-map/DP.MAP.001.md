...
> Auto-generated from frontmatter on 2026-03-16. Do not edit manually.
...
| DP.ROLE.012.SC.01 | 01 Strategy Session | Еженедельная сессия стратегирования (strategy_day 7:00): анализ прошлой недели, сдвиг месячного окна и формирование плана на неделю | draft |
...
| DP.SC.003 | Обучение и развитие | Пользователь получает персонализированное обучение: вопросы, проверку ДЗ, ленту знаний, марафоны | draft |
...
| DP.SC.005 | Публикация контента | Контент автора публикуется в клубе по расписанию с автоматическим отслеживанием реакций | draft |
...
*Generated by `scripts/generate-map.py` on 2026-03-16*