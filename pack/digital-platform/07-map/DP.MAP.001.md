...
| DP.ARCH.004 | Архитектура данных Neon (Database-per-Service) | 6 баз данных в Neon по принципу database-per-service. ERD предметной области. Принята на встрече ИТ 14 апр 2026. | active |
