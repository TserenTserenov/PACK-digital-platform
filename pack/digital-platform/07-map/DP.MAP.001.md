...
> Auto-generated from frontmatter on 2026-06-04. Do not edit manually.
...
| DP.ROLE.012 | 00 Role Passport | Роль Стратег (R1) — стратегирование (WHAT/WHY): discovery неудовлетворённостей, диагностика состояния, приоритеты месяца. Операционное планирование (неделя/день) передано Плановику (DP.ROLE.066), РП378. | draft |
...
*Generated by `scripts/generate-map.py` on 2026-06-04*