...
> Auto-generated from frontmatter on 2026-04-14. Do not edit manually.
...
| DP.ARCH.004 | Архитектура данных Neon (Database-per-Service) | 7 баз данных в Neon по принципу database-per-service. ERD, диаграммы связей, справочник таблиц, принятые архитектурные решения. Принята на встрече ИТ 14 апр 2026. | active |
...
*Generated by `scripts/generate-map.py` on 2026-04-14*