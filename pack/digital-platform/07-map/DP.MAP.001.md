...
> Auto-generated from frontmatter on 2026-04-08. Do not edit manually.
...
| DP.SC.119 | Рабочее пространство из браузера | Пользователь получает работающее IWE-пространство из браузера — без git, без терминала, без VS Code | draft |
...
*Generated by `scripts/generate-map.py` on 2026-04-08*