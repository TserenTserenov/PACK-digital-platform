...
> Auto-generated from frontmatter on 2026-07-17. Do not edit manually.
...
| DP.SC.059 | Сторож разрывов данных (data-gap watchdog) | Пилот получает Telegram-алерт при превышении числового порога разрыва свежести в зарегистрированном потоке персональных данных (health.db, WakaTime) — и гарантию, что сам детектор не умер молча | draft |
...
*Generated by `scripts/generate-map.py` on 2026-07-17*