...
| DP.M.008 | Операционные правила IWE (Operating Rules) | 14 операционных правил интеллектуальной рабочей среды. Каждое правило = инвариант метода работы. Реализация (протоколы, скрипты, skills) — в DS/FMT, правила — здесь | active |
