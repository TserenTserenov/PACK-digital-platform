...
> Auto-generated from frontmatter on 2026-06-10. Do not edit manually.
...
- Missing `summary`: DP.ROLE.073 (DP.ROLE.073-pathfinder.md)
...
- Missing `summary`: DP.SC.173 (DP.SC.173-pathfinder.md)
- Missing `summary`: DP.VM.001 (P1-P9-calibration-matrix.md)

---

*Generated by `scripts/generate-map.py` on 2026-06-10*