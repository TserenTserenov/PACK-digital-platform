...
> Auto-generated from frontmatter on 2026-07-20. Do not edit manually.
...
| DP.SC.062 | Публикация курируемого манифеста в исследовательский репозиторий iwesys | Ретранслятор канона (DP.ROLE.081) переводит и публикует ЯВНО ПЕРЕЧИСЛЕННЫЙ манифест файлов из рабочего governance-репозитория (не весь repo/docs) в целевой публичный репозиторий iwesys — третий режим существующей роли, для потребителей без диспозиции 'вся документация репозитория публична' (WP-493 Лаборатория, будущий РП495). | draft |
...
*Generated by `scripts/generate-map.py` on 2026-07-20*