...
| DP.SC.104 | Адаптивная персонализация через цифровой двойник | ЦД обеспечивает адаптивную персонализацию платформы — три механизма: персонализация (платформа), индивидуализация (пользователь), адаптивность (система) | draft |
