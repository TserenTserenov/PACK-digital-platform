...
4. **Инструменты исполнителя:** Эта таблица показывает сервисы (ЧТО делается). Для полного списка инструментов (ЧЕМ делается) каждого исполнителя → [Таблица РА §3.5](../02-domain-entities/DP.AGENT.001-ai-agents.md#35-таблица-ра-роли--исполнители--инструменты)
