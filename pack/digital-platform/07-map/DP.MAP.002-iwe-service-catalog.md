...
|---|--------|------|------|------------|------|-------------|---------|------------|
| S01 | **Day Plan** | [R1 Стратег](../02-domain-entities/DP.ROLE.001-platform-roles.md#агентские-роли-grade-2) | WeekPlan, inbox-triage, вчерашний DayPlan, коммиты | DayPlan | R14 Заказчик, R20 Рецензент | A1 Claude → [strategist.sh](../../../../DS-IT-systems/DS-ai-systems/strategist/scripts/strategist.sh) | ⏰ ежедн 04:00 | [PROCESSES](../../../../DS-IT-systems/DS-ai-systems/strategist/PROCESSES.md) |
