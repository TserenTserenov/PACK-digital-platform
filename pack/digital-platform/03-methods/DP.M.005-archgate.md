...
**Шаг 1 — Контекстные приоритеты:** Спросить (или определить по контексту): какие 1–2 характеристики критичны для данного решения? Пометить как критические → при ❌ в них = немедленный СТОП (§6, условие 1).
