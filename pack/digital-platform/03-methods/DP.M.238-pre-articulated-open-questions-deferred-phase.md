...
|------|--------------------------|
| Тяга к быстрой формулировке «обсудить X» | Она создаёт ощущение зафиксированности за секунды; три критерия хорошего вопроса требуют усилия ровно в момент закрытия фазы, когда хочется закончить — и антипаттерн метода воспроизводится при знании метода |
| Вопросы фиксируются и застывают | Между откладыванием и peer-session часть вопросов решается по ходу другой работы; сверка «что ещё живо» перед сессией не делается, и сессия стартует с устаревшего списка — реконструкция возвращается через другую дверь |
