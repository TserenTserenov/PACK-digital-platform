...
| **Среда (IWE)** | Персональная интегрированная система для интеллектуальной работы. Объединяет модули Платформы и собственные инструменты пользователя. Син.: IWE (Intellect Work Environment). Аналог IDE (Integrated Development Environment) для разработчика — но для развития интеллекта, а не написания кода | U.System | DP.CONCEPT.002, DP.D.016, DP.D.017 |
